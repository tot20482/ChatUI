              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
                  <h4 className="font-semibold text-gray-800">
                    Media ID: <span className="font-mono text-sm">{newsData.media_id || 'N/A'}</span>
                  </h4>
                  
                  <div className="flex flex-wrap gap-2">
                    {newsData.content?.news_sentiment_type && (
                      <span className={`text-xs px-2 py-1 rounded-full ${getSentimentColor(newsData.content.news_sentiment_type)}`}>
                        {newsData.content.news_sentiment_type}
                      </span>
                    )}
                  ...
                  {newsData.content?.content ? (
                    <div>
                      {typeof newsData.content.content === 'string' ? (
                        <p className="whitespace-pre-wrap">{newsData.content.content}</p>
                      ) : (
